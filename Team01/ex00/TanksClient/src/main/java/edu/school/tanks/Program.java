package edu.school.tanks;

import edu.school.tanks.models.Bullet;
import edu.school.tanks.models.Tank;
...
public class Program extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        player = new Tank("playerup.png", 480, 850, root, 20, 980, gc);
        enemy = new Tank("enemydown.png", 480, 72, root, 700, 20, gc);
    ...
    private void outShoot(String img, Tank tank, Tank enemy, double forCorrect) {
        Bullet bullet = new Bullet(tank, img, gc, enemy, forCorrect);
        bullet.start();
    }
